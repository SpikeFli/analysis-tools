...
# Generate conditional INSERT statements for new People records
    ...
    for _, row in should_be_active_df.iterrows():
        ...
        sql_statements.append(f"        '{username}',")
    ...
    sql_statements.append("WHERE UserRef_Type = 'Phone Assignment Fix';")
    sql_statements.append("")
    ...
    sql_statements.append("WHERE sd.UserRef_Type = 'Phone Assignment Fix'")
